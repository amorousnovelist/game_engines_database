...
{
	/*
	* Перенаправление отображение формата кодировки 
...
Введите 'y', если вы хотите, введите 'n' в ином случае: ");
		...
		/*
		* Команда поиска записи в заданном диапазоне
		...
		*/
		...
		case 'a': {
			...
			*/
			...
			/*Валидация инициализации полей последней структуры*/
		...
		case 't': {
			...
			* в команде "добавления записи с пользовательскими данными..."
			*/
